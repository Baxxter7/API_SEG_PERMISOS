...
class seg_permisos(models.Model):
    ...
    per_insercion = models.CharField(max_length=1)
    per_eliminar = models.CharField(max_length=1)
    per_actualizar = models.CharField(max_length=1)
    per_consultar = models.CharField(max_length=1)
